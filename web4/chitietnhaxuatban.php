...
$obj=new nhaxuatban();
    ...
    $limit=1;//số bản ghi trên 1 trang (2 bản ghi trên 1 trang)
    $obj1 = new sach();
    $ma =isset($_GET['manxb']) ? $_GET['manxb'] : "";
    $data = $obj1 ->getsach_nxb($ma);//var_dump($data);
    ...
    $start=($page-1)*$limit;
    $arrs =$obj1->getsach_nxbPT($ma,$start,$limit);//var_dump($arrs);
  ?>
...
<div class="pager" style="margin-left:300px;">
          <div class="pages">
            ...
            <li <?php if($page == $i) echo "class='active'"; ?> ><a href="chitietnhaxuatban.php?page=<?php echo $i; ?>&manxb=<?php echo $ma; ?>"><?php echo $i; ?></a></li>
            <?php } ?>
            </ul>
          </div>
</div>
